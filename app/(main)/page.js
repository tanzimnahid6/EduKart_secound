...
import { getCategories } from "@/queries/categoris";
    ...
    <>
        ...
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center relative isolate">
          ...
          >
            <div
              ...
              className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#c55684] to-[#3e34c9] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            />
          </div>
      ...
      <section id="courses" className="container space-y-6   md:py-12 lg:py-24">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-4 gap-4">
          {courses.map((course) => {
            return <CourseCard course={course} key={course.id}></CourseCard>;
          })}
        </div>
      </section>
    </>
